      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8 hover:shadow-2xl transition">
            ...
            <ul className="text-gray-600 space-y-2">
              <li>🌍 <a href="/resources/open-access/" className="text-blue-600 hover:underline">Open Access Policy</a></li>
              <li>🔒 <a href="#" className="text-blue-600 hover:underline">Copyright & Licensing</a></li>
              <li>🖊️ <a href="/resources/plagiarism-and-ethics/" className="text-blue-600 hover:underline">Plagiarism & Ethics</a></li>
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8 hover:shadow-2xl transition">
            ...
            <ul className="text-gray-600 space-y-2">
              <li>📝 <a href="/resources/cover-letter/" className="text-blue-600 hover:underline">Cover Letter Template</a></li>
